...
namespace UnitTestProject1
{
    ...
    public class DataServiceTests
    {
        ...
        public void TestGetAllKatalogByThisClientAndThisDay()
        {
            ...
            DataRepository dataRepository = new DataRepository(context, plik);
            DataService dataService = new DataService(dataRepository);
            HashSet<Katalog> actual = dataService.GetAllKatalogBuyByThisClientAndThisDay(1, DateTime.Parse("26.10.2018 00:00:00"));
        ...
        public void TestGetAllZdarzeniaThisDay()
        {
            ...
            Zdarzenie zd1 = new Sprzedaz(4, dataRepository.GetOpisStanuById(1), 1, 1, dataRepository.GetClientById(1), DateTime.Parse("26.10.2018 00:00:00"));
            expectedZdarzenia.Add(zd1);

            ObservableCollection<Zdarzenie> actual = dataService.GetAllZdarzeniaThisDay(DateTime.Parse("26.10.2018 00:00:00"));
        ...
        public void TestGetAllZdarzeniaThisClient()
        {
            ...
            Zdarzenie zd1 = new Sprzedaz(4, dataRepository.GetOpisStanuById(1), 1, 1, dataRepository.GetClientById(1), DateTime.Parse("26.10.2018 00:00:00"));
            Zdarzenie zd2 = new Sprzedaz(5, dataRepository.GetOpisStanuById(2), 1, 1, dataRepository.GetClientById(1), DateTime.Parse("27.10.2018 00:00:00"));
            expectedZdarzenia.Add(zd1);
